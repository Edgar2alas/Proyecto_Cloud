...
const s: Record<string, React.CSSProperties> = {
  ...
  headerSub: { fontSize: "clamp(10px, 0.8vw, 13px)", color: "#94a3b8", margin: 0 },
  ...
  statLabel: { fontSize: "clamp(10px, 0.75vw, 13px)", color: "#64748b" },
  mainLayout: {
    display: "grid",
    gridTemplateColumns: "clamp(180px, 16vw, 260px) 1fr clamp(220px, 20vw, 320px)",
  ...
  tableWrapper: { overflowY: "auto" as const, flex: 1 },
  table: { width: "100%", borderCollapse: "collapse" as const, fontSize: "clamp(11px, 0.85vw, 13px)" },
  th: {
    padding: "clamp(4px, 0.5vw, 8px) clamp(5px, 0.6vw, 10px)",
  ...
  td: { padding: "clamp(5px, 0.6vw, 8px) clamp(4px, 0.5vw, 8px)", color: "#cbd5e1" },
  tag: {
